...
queries = [
    "downtown retail vacancy rates 2023 2024 statistics San Francisco New York Chicago",
    "urban doom loop retail vacancy downtown",
    "flight to quality retail real estate downtown",
    "adaptive reuse downtown retail vacancy"
]
