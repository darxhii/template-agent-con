...
queries = [
    "Amazon labor union recent votes JFK8 ALB1",
    "Starbucks Workers United recent union votes",
    "Apple store unionization votes IAM CWA",
    "REI Trader Joe's union election results",
    "NLRB retail union elections recent"
]
...
with open('union_results.json', 'w') as f:
